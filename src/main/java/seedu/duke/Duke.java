...
//}
//The above code will help to add user to the data storage and start the writing session
//However, we need to modify the Test file later before pushing again to pass all the test
//Now, just create the JAR file first, I suppose it should be ok?
